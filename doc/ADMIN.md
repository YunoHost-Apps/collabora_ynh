...
If you want to connect with Nextcloud, you have to install the [Nextcloud Office](https://apps.nextcloud.com/apps/richdocuments) app in Nextcloud, and configure it with the domain of your Collabora installation.
